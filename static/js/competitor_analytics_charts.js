// Competitor Analytics Charts JavaScript
    ...
    window[period + 'Chart'] = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: metricValues,
                backgroundColor: currentChartType === 'bar' ? colors : 'rgba(0, 0, 0, 0)',
...
// Update all charts with the selected metric and chart type
function updateCharts() {
    ...
    createChart('daily-chart', dailyData, 'daily');
    createChart('mtd-chart', mtdData, 'mtd');
    createChart('ytd-chart', ytdData, 'ytd');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add event listeners to chart type toggle buttons
    const chartTypeButtons = document.querySelectorAll('.chart-type-toggle .btn');
