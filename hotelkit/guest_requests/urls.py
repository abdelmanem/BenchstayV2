...
urlpatterns = [
    ...
    path('guest-requests/export/excel/', GuestRequestsExportExcelView.as_view(), name='export_excel'),
    path('guest-requests/export/pdf/', GuestRequestsExportPDFView.as_view(), name='export_pdf'),
